...
filepath = '/Users/hunte/Documents/Python/OCTATEST2.png'
model = '/Users/hunte/Documents/Python/AVA_model_3.hdf5'
...
#tensor_img = tf.image.resize(pil_img,[320,320,3])
#tensor_img = tf.io.decode_image(tensor_img, channels = 3)
